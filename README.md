...
You need to get `glslc` from somewhere, for example from listed games above. It will be in exefs partition as some numbered "subsdk" file. You need to convert it to ELF file with `nx2elf`, and put generated elf file to root of this repository.
