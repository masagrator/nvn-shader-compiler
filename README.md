...
"Shader version" cannot be newer than what game supports. NVN is backwards compatible, which means so you can use old shader version with newer versions of NVN.
